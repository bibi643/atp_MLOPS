...
y_pred = train_logistic_regression_model(
    X_train, X_test, y_train, y_test, logistic_model)
print('shape pred: ', y_pred.shape)

# 06 modele predict
print('Lancement du code 6: modele_predict.py')
accuracy, confusion, classification_rep = accuracy_and_confusion_matrix(
    y_test, y_pred)
...
# 07 model save
save_model_pickle(logistic_model, 'atp_logistic_model.pkl')
save_model_joblib(logistic_model, 'atp_logistic_model.joblib')
